  ...
  <div class="punk-container px-12 md:px-40">
    ...
    <div class="relative grid mt-32 justify-center items-center grid-cols-1 xl:grid-cols-2 gap-5 z-5">
      <div class="text-white flex flex-col gap-4">
        ...
        <a href="/gallery" class="punk-btn text-lg md:text-2xl w-full md:w-4/12 flex justify-center items-center gap-2">Take Me Home</a>
      </div>
      <div class="p-10 md:p-24">
        <img src="/nfts/17.png" class="w-full h-auto" alt="nft">
      </div>
    </div>
  </div>
  <Footer />
